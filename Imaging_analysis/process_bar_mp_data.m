...
% Scatter data
scatter(ball_forward_velocity(bar_on==1 & select & gain8==1), dff(bar_on==1 & select & gain8==1), 20, 'b', 'filled', 'DisplayName', 'no bar, gain 8');
scatter(ball_forward_velocity(gain8==1 & select & bar_on ==0), dff(gain8==1 & select & bar_on ==0), 20, 'r', 'filled', 'DisplayName', 'gain 8, bar');
scatter(ball_forward_velocity(gain4==1 & select & bar_on ==0), dff(gain4==1 & select & bar_on ==0), 20, 'g', 'filled', 'DisplayName', 'gain 4, bar');
scatter(ball_forward_velocity(gain4==1 & select & bar_on ==1), dff(gain4==1 & select & bar_on ==1), 20, 'm', 'filled', 'DisplayName', 'gain 0.4, no bar');
