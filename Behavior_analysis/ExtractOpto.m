function [triggerIdx, rho, Saccade_turns, no_Saccade, bData_interp] = ExtractOpto(exptData, window, minVelforward, minVelyaw, Thres)
...
title("2D Path Trajectory with OptoStim and Saccades")
...
% Correct legend
legend({'Both OptoStim & Saccade (Purple)', 'Saccade (Red)', 'OptoStim ON (Green)', 'No Saccade & Opto OFF (Black)', 'Start Position (Green)'}, 'Location', 'best');
