function [triggerIdx, rho, Meno_chunks, not_Meno_chunks,bData_interp] = SegmentMenovsNotMeno_ephys(exptData, window, minVel,highThres,lowThres)
...
total_mov_mm = abs(bData_interp.forwardVelocity) + abs(bData_interp.sidewaysVelocity) + abs(deg2rad(bData_interp.angularVelocity))*4.5;        
