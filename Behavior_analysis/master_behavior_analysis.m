...
stim_directory = fullfile(base_path, ['stim', stim_number]);
...
%% find turns
[yawVelPeakTimes, boutStartTimes, boutEndTimes, yawVelPeakInd, boutStartInd,...
    boutEndInd]=findYawVelPeaksFT(exptData, 30, [0.2,3], exptData.motion, 1);
